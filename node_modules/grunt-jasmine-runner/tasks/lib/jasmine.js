...
exports.buildSpecrunner = function(dir, options, reporters){
  ...
  var jasmineAMDHelper = __dirname + '/../jasmine/jasmine-amd-helper.js';

  var styles = getRelativeFileList(jasmineCss);

  if (options.amd) {
    var specs = getRelativeFileList(options.specs);
    var scripts = getRelativeFileList(jasmineCore, options.helpers, phantomHelper, reporters);
    var start = getRelativeFileList(jasmineAMDHelper);
  } else {
